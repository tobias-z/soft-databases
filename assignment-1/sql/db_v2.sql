...
CREATE TABLE [dbo].[book] (
    ...
    CONSTRAINT [FK_book_published_item] FOREIGN KEY ([book_id]) REFERENCES [dbo].[published_item] ([published_item_id])
);

CREATE TABLE [dbo].[magazine] (
    [magazine_id] BIGINT NOT NULL,
    CONSTRAINT [PK_magazine] PRIMARY KEY CLUSTERED ([magazine_id] ASC),
    CONSTRAINT [FK_magazine_published_item] FOREIGN KEY ([magazine_id]) REFERENCES [dbo].[published_item] ([published_item_id])
);
